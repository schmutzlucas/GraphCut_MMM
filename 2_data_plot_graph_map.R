...
saveRDS(mae_bias,  paste0("output/", var, "_mae_bias.rds"))
saveRDS(mae_bias_map,  paste0("output/", var, "_mae_bias_map.rds"))
saveRDS(mse_gradient,  paste0("output/", var, "_mse_gradient.rds"))
saveRDS(mse_gradient_map,  paste0("output/", var, "_mse_gradient_map.rds"))
